        ...
        <div className="details__header__col">
          {isActive ? (
            <div className="details__header__controller-left">
              <span>
                <img src="./img/details/close-right.svg" alt="" />
              </span>
              <span>
                <img src="./img/details/resize.svg" alt="" />
              </span>
              <span>
                <img src="./img/details/up-arrow.svg" alt="" />
              </span>
              <span>
                <img src="./img/details/down-arrow.svg" alt="" />
              </span>
            </div>
          ) : (
            <div className="details__header__controller">
              <span>
                <img src="./img/details/close.svg" alt="" />
              </span>
              <span>
                <img src="./img/details/up-arrow.svg" alt="" />
              </span>
          ...
          <div className="details__header__userid">#600009</div>
          <div className="details__header__username">Ali Brian</div>
        </div>
        <div className="details__header__col">
